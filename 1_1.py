...
class TextGraph:
    ...
    def random_walk(self):
        ...
        print("Random walk started. Press 's' then Enter to stop at any time.")
    ...
    def _check_user_stop(self):
        """Check if user wants to stop the random walk (non-blocking)"""
        import sys
        import select
        
        # Check if there's input ready (for Unix-like systems)
